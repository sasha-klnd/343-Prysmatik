...
type Screen =
  ...
  | 'user-signup' | 'user-login' | 'my-rides';
...
export default function App() {
  ...
  const handleNavigate = (screen: string) => {
    if (screen === 'home') {
      ...
      setCurrentScreen(isAdminAuthenticated ? 'admin' : 'admin-login');
  ...
  const handleAdminLogin  = (success: boolean) => { if (success) { setIsAdminAuthenticated(true); setCurrentScreen('admin'); } };
  const handleAdminLogout = () => { setIsAdminAuthenticated(false); setCurrentScreen('conversation'); };
